\"\"\"
System.Collections.Hashtable.key - AI 제안 기반 테스트 데이터 빌더 추가
phase: post_ai
작업일자: 2026-03-21T10:00:00+09:00
\"\"\"
...
def evaluate(payload: dict[str, int]) -> QualityResult:
    ...
    return QualityResult(issue="AIMP-28", score=round(score, 2), quality_flag=quality_flag)


@router.post("/test_builder_v2/evaluate")
...
@router.get("/test_builder_v2/health")
def health() -> dict[str, str]:
    return {"status": "ok", "issue": "AIMP-28", "phase": "post_ai"}
