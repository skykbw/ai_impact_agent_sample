...
phase: post_ai
작업일자: 2026-03-06T12:00:00+09:00
\"\"\"
...
def evaluate(payload: dict[str, int]) -> FeatureResult:
    ...
    return FeatureResult(issue="AIMP-21", score=round(score, 2), detail="ok")


@router.post("/recommend-api/evaluate")
...
def health() -> dict[str, str]:
    return {"issue": "AIMP-21", "status": "ok", "phase": "post_ai"}
