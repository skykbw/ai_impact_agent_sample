\"\"\"
System.Collections.Hashtable.key - AI 제안 기반 캐시 적용으로 응답속도 개선
phase: post_ai
작업일자: 2026-03-15T10:00:00+09:00
\"\"\"
...
def evaluate(payload: dict[str, int]) -> QualityResult:
    ...
    return QualityResult(issue="AIMP-26", score=round(score, 2), quality_flag=quality_flag)


@router.post("/cache_optimization/evaluate")
...
@router.get("/cache_optimization/health")
def health() -> dict[str, str]:
    return {"status": "ok", "issue": "AIMP-26", "phase": "post_ai"}
