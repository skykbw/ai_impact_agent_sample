\"\"\"
System.Collections.Hashtable.key - AI 도입 후 회고 및 품질 지표 정리
phase: post_ai
작업일자: 2026-03-24T10:00:00+09:00
\"\"\"
...
def evaluate(payload: dict[str, int]) -> QualityResult:
    ...
    return QualityResult(issue="AIMP-29", score=round(score, 2), quality_flag=quality_flag)


@router.post("/post_retro_quality/evaluate")
...
@router.get("/post_retro_quality/health")
def health() -> dict[str, str]:
    return {"status": "ok", "issue": "AIMP-29", "phase": "post_ai"}
