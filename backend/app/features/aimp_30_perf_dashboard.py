\"\"\"
System.Collections.Hashtable.key - AI 활용 성능 측정 대시보드 개선
phase: post_ai
작업일자: 2026-03-27T10:00:00+09:00
\"\"\"
...
def evaluate(payload: dict[str, int]) -> QualityResult:
    ...
    return QualityResult(issue="AIMP-30", score=round(score, 2), quality_flag=quality_flag)


@router.post("/perf_dashboard/evaluate")
...
@router.get("/perf_dashboard/health")
def health() -> dict[str, str]:
    return {"status": "ok", "issue": "AIMP-30", "phase": "post_ai"}
