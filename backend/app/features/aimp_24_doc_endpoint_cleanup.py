\"\"\"
System.Collections.Hashtable.key - AI 보조 문서화 자동화 엔드포인트 정리
phase: post_ai
작업일자: 2026-03-09T10:00:00+09:00
\"\"\"
...
def evaluate(payload: dict[str, int]) -> QualityResult:
    ...
    return QualityResult(issue="AIMP-24", score=round(score, 2), quality_flag=quality_flag)


@router.post("/doc_endpoint_cleanup/evaluate")
...
@router.get("/doc_endpoint_cleanup/health")
def health() -> dict[str, str]:
    return {"status": "ok", "issue": "AIMP-24", "phase": "post_ai"}
