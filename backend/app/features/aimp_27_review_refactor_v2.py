\"\"\"
System.Collections.Hashtable.key - AI 코드 리뷰 보조로 리팩터링 반영
phase: post_ai
작업일자: 2026-03-18T10:00:00+09:00
\"\"\"
...
def evaluate(payload: dict[str, int]) -> QualityResult:
    ...
    return QualityResult(issue="AIMP-27", score=round(score, 2), quality_flag=quality_flag)


@router.post("/review_refactor_v2/evaluate")
...
@router.get("/review_refactor_v2/health")
def health() -> dict[str, str]:
    return {"status": "ok", "issue": "AIMP-27", "phase": "post_ai"}
